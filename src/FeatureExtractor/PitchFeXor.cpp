...
{
	definition.push_back("<Pitch::begin> log-f0 of the first frame of vowel, normalized with average sentence log-f0");
	definition.push_back("<Pitch::end> log-f0 of the last frame of vowel, normalized with average sentence log-f0");
	...
	definition.push_back("<Pitch::min> The smallest log-f0 value, normalized with average sentence log-f0");
	definition.push_back("<Pitch::n_min> The smallest log-f0 value, normalized with average vowel log-f0");
	definition.push_back("<Pitch::max> The largest log-f0 value, normalized with average sentence log-f0");
	definition.push_back("<Pitch::n_max> The largest log-f0 value, normalized with average vowel log-f0");
	definition.push_back("<Pitch::avgPitch> Average vowel log-f0, normalized with average sentence log-f0");
